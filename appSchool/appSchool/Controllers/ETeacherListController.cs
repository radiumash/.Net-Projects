...
{
    [NoCache]
    public class ETeacherListController : Controller
    {
        ...
        public ActionResult SendGeneralMessegeView()
        {
         ...
         public ActionResult PartialTeacherView(string mClassSetup)
         {
            ...
            return PartialView("ListTeacher", new UnitOfWork().teacherlistservice.GetTeacherList(byte.Parse(Session["CompID"].ToString()), byte.Parse(Session["BranchID"].ToString())));
        }
