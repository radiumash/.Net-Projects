...
namespace appSchool.Controllers
{
    ...
    public class AppModuleController : Controller
    {
        ...
        public static List<List<string>> Split(List<string> source)
        {
         ...
         public ActionResult PartialAppModuleView()
         {
        ...
        public ActionResult AddNewModule(AppModule obj)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    unitOfWork.appModuleservices.AddNewAppModuleData(obj);
                    unitOfWork.Save();
                }
                catch (Exception e)
                {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult UpdateAppModule(AppModule obj)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    unitOfWork.appModuleservices.UpdateAppModule(obj);
                    unitOfWork.Save();
                }
                catch (Exception e)
                {
