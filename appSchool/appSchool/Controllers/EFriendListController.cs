...
{
    [NoCache]
    public class EFriendListController : Controller
    {
        ...
        public ActionResult SendGeneralMessegeView()
        {
         ...
         public ActionResult PartialFriendView(string mClassSetup)
         {
            ...
            return PartialView("ListFriend", new UnitOfWork().vstudentfriendListservice.GetStudentList(int.Parse(Session["SessionID"].ToString()), int.Parse(Session["ClassSetupID"].ToString())));
        }
