...
{
    //[NoCache]
    public class EFeesController : Controller
    {
        //
        // GET: /FeesManager/
        ...
        public ActionResult ListFeePartial()
        {
            if (Session["UserID"] == null) { return Redirect("~/"); }
            return PartialView("GridViewPartial", unitOfWork.vStudentFeeService.GetStudentFees(int.Parse(Session["UserID"].ToString()),int.Parse(Session["SessionID"].ToString()),byte.Parse(Session["CompID"].ToString()), byte.Parse(Session["BranchID"].ToString())));
        }
