var examRemarkMasterController = {

    splitterResized: function (s, e) {
        switch (e.pane.name) {
            case 'ExamRemarkMasterBody':
                GridExamRemarkMaster.SetHeight(e.pane.GetClientHeight() - 2);
                GridExamRemarkMaster.SetWidth(e.pane.GetClientWidth() - 2);
                break;
                //case 'ClassesFooter':
    ...
    RowSelectionChange: function OnGridFocusedRowChanged(s, e) {
        ...
        s.GetRowValues(s.GetFocusedRowIndex(), 'ERID', examRemarkMasterController.RefreshTabsView);
    },
