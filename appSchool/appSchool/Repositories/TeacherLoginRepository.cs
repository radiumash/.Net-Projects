...
{
    public class TeacherLoginRepository : GenericRepository<StudentLogin> 
    {
        public TeacherLoginRepository() : base(new dbSchoolAppEntities()) { }
        public TeacherLoginRepository(dbSchoolAppEntities dbContext) : base(dbContext) { }
        ...
        //public TeacherLogin IsTeacherValid(ModelTeacherLogin objmodel)
        //{

        //    TeacherLogin objLog = new TeacherLogin();

        //    objLog = this.context.TeacherLogins.Where(i => i.TeacherUserName == objmodel.UserName && i.Password == objmodel.Password).FirstOrDefault();
